...
export const Hero = props => {
  ...
  const getImagesArray = () => {
    const imagesConfig =
      siteConfig('STARTER_HERO_PREVIEW_IMAGES', null, config) ||
      ...
      {images.length > 0 && (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to bottom, rgba(0,98,155,0.7), rgba(0,98,155,0.8))'
            }}
          ></div>
          ...
          {images.length > 1 && (
            <>
              <button
                ...
                className='absolute left-8 top-1/2 transform -translate-y-1/2 bg-white/20 dark:bg-dark-2/20 backdrop-blur-sm rounded-full p-3 text-white hover:bg-white/40 dark:hover:bg-dark-2/40 transition-all z-20 hover:scale-110 cursor-pointer focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-transparent'
                aria-label='上一張'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
              ...
              <button
                ...
                className='absolute right-8 top-1/2 transform -translate-y-1/2 bg-white/20 dark:bg-dark-2/20 backdrop-blur-sm rounded-full p-3 text-white hover:bg-white/40 dark:hover:bg-dark-2/40 transition-all z-20 hover:scale-110 cursor-pointer focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-transparent'
                aria-label='下一張'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
            ...
            <div className='absolute bottom-12 left-1/2 transform -translate-x-1/2 flex justify-center z-20'>
              {images.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full mx-2 transition-all duration-300 cursor-pointer focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-transparent ${
