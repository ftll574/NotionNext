              ...
              <div className='w-full px-4 lg:w-1/2'>
                <div className='relative mx-auto'>
                  ...
                  <div className='absolute -left-10 top-1/2 transform -translate-y-1/2 glassmorphism p-6 rounded-lg shadow-xl z-[3] transition-all duration-500 hover:shadow-2xl hover:scale-105 dark:border dark:border-gray-700'>
                    <h3 className='text-4xl font-bold bg-gradient-to-r from-primary to-blue-dark bg-clip-text text-transparent'>
                      {siteConfig('STARTER_ABOUT_TIPS_1', '1000+')}
                    </h3>
                    <p className='text-body-color mt-1 dark:text-gray-300'>
                      {siteConfig('STARTER_ABOUT_TIPS_2', '長期客戶')}
                    </p>
                  </div>
                </div>
              </div>
