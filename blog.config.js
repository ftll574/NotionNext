...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zhenyu Li', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || "采源的小狗汪汪", // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-ten-sand.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '金采源, Kimchaewon, 采源的小狗汪汪, 瑞典文, 日本旅遊', // 网站关键词 英文逗号隔开
